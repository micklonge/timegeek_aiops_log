package log.normalization.common;
...
public class DatetimeUtil {
    ...
    public static void main(String []args) throws Exception {
    	System.out.println(DatetimeUtil.getCurrentYear(TimezoneUtil.getChinaTimeZone()));
    	System.out.println(DatetimeUtil.getCurrentMonth(TimezoneUtil.getChinaTimeZone()));
    	System.out.println(DatetimeUtil.getCurrentDay(TimezoneUtil.getChinaTimeZone()));
    	System.out.println(internalGetCurrentDateTime("dd", TimezoneUtil.getChinaTimeZone()));
    }
}
